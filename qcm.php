		...
		<section>
			...
			<form name="myform" method="post" id="myform" action="proc.php" onsubmit="return validate()">
				<div class="container">
					...
					<p>
						2.En quelle entreprise des GAFAM avez vous le moins confiance?</br> En d'autre termes, laquelle est le plus suceptible de vous espionner
					</p>
					...
					<p class="question">
						3.Combien d'appareils intelligents (téléphone, four,frigidaire,caméra,</br> remote-store,répéteur,lave linge) estimez vous avoir dans la maison?
					</p>
					...
					<p class="question">
						4.Quels moteurs de recherche utilisez vous à la maison? Plusieurs choix possibles
					</p>
					...
					<p class="question">
						5.Utlisez-vous un assistant sonore chez vous?(type Alexa, Cortana, Siri ou autre)
					</p>
					...
					<p class="question">
						6.Possédez vous des bloqueurs de publicité sur vos navigateurs?
					</p>
					...
					<p class="question">
						7.Pensez vous que l'anonnymat est impossible à l'ère du numérique?
					</p>
					...
					<p class="question">
						8.Faites vous toutes les mises à jour de sécurité sur votre téléphone et votre PC?
					</p>
					...
					<p class="question">
						9.Avez vous déjà été victime de piratage sur vos comptes connectés?
					</p>
					...
					<p class="question">
						10.Comment utilisez vous vos mots de passe?
					</p>
					...
					<p class="question">
						11.Possédez vous des caméraras connectées chez vous ?</br>
					</p>
					...
					<p class="question">
						12.Avez-vous masqué la webcam de vos ordinateurs ou pensez-vous à le faire ?</br>
					</p>
					...
					<p class="question">
						13.Avez-vous déjà reconfigurés votre box ? (Changement de nom, mot de passe, cryptage, etc).</br>
					</p>
					...
					<p class="question">
						14.Pensez-vous que votre antivirus sur votre PC est performant ?</br>
					</p>
					...
					<p class="question">
						15.Avez-vous pour habitude d'utiliser des pseudos quand vous créez un compte en ligne ou vous préférez utiliser votre nom ou prénom ?</br>
					</p>
					...
					<p class="question">
						16.Pensez- vous qu'il est possible de pirater une voiture connectée ?</br>
					</p>
					...
					<p class="question">
						17.Pensez-vous que vos données sont protégées dans une voiture connectée ?</br>
					</p>
					...
					<p class="question">
						18.Pensez-vous qu'une voiture connectée augmente le risque d'accident ?</br>
					</p>
					...
					<p class="question">
						19.A combien estimez-vous le nombre de voitures connectées en circulation en France en 2018 ?</br> 
					</p>
					...
					<p>
						20.Possédez-vous une voiture connectée ?</br> 
					</p>
